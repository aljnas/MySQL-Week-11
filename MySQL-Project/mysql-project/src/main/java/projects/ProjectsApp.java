...
private void deleteProject() {
	...
	System.out.println("Project " + projectId + " was delete succesfully.");
...
private void updateProjectDetaisl() {
...
private int getUserSelection() {
	...
	Integer input = getIntInput("Enter menu selections");
